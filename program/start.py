...
💭 [{BOT_NAME}](https://t.me/{BOT_USERNAME}) **ʜᴏɪ, ɪ ᴍ ᴀʟɪꜱʜᴀ ʀᴏʙᴏᴛ

ɪ'ᴍ ʜᴇʀᴇ ᴛᴏ ʜᴇʟᴘ ʏᴏᴜ ᴛᴏ ᴍᴀɴᴀɢᴇ ʏᴏᴜʀ ɢʀᴏᴜᴘꜱ ᴀɴᴅ ᴘʟᴀʏ ᴍᴜꜱɪᴄ, ɪ ᴍ ᴠᴇʀʏ ᴘᴏᴡᴇʀꜰᴜʟʟ ʙᴏᴛ!**
...
""",
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton(
                        "🌐 Source Code", url="https://t.me/Shayri_Music_Lovers"
                    )
                ],
            ]
        ),
